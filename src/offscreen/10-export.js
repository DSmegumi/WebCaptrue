...
async function exportSession(sessionId, meta) {
  ...
  files.push(textFile("runtime/targets.jsonl", jsonl((byType.targetDiscovery || []).concat(byType.targetDiscoveryFallback || []).concat(byType.targetAttributionGap || []).concat(byType.targetAttached || []).concat(byType.targetAttachFailed || []).concat(byType.targetAutoAttachFailed || []).concat(byType.targetDetached || []).concat(byType.targetDestroyed || []))));
