...
for (const marker of ["Target.setDiscoverTargets", "targetId", "captureFullPageScreenshot", "interactionId", "requestKey", "params.redirectResponse", "bridgeOrphanExtraInfo", "flushAllExtraInfo", "waitForPendingDebuggerEvents", "waitForPendingRecordWrites", "stopTargetPolling"]) {
