...
for (const marker of ["Target.setDiscoverTargets", "targetId", "captureFullPageScreenshot", "interactionId", "requestKey", "params.redirectResponse", "waitForPendingDebuggerEvents", "waitForPendingRecordWrites", "stopTargetPolling"]) {
